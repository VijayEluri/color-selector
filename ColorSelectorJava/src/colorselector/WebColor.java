...
class ColorEnumRenderer extends BasicComboBoxRenderer {
     ...
     * 
     */
    private static final long serialVersionUID = -7275269358700029531L;
    ...
    public Component getListCellRendererComponent(JList list, Object value,
        ...
        if (isSelected) {
            component.setBackground(contrast);
            component.setForeground(colorEnum.toColor());
        } else {
            component.setBackground(colorEnum.toColor());
            component.setForeground(contrast);
        }
